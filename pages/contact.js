...
const Contact = () => {
  return (
    ...
    <div name='contact' className='flex justify-center text-2xl py-8 bg-red-500 text-black'>
        <form method='POST' action='https://getform.io/f/fe67a61c-f025-48e1-a73b-bcd7c7066ec4' className='flex flex-col max-w-[600px] w-full'>
            ...
            <button className='text-white border-2 hover:bg-red-500 hover:border-red-600 px-4 py-3 my-8 mx-auto flex items-center'> Send </button>
        </form>
    </div> 
    </Layout>
  )
